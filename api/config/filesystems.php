...
return [
    ...
    */
    ...
    'disks' => [
        ...
        //ADD>>> PUKYO.shenjianghui 2021-11-12 禅道0 添加阿里云oss配置
        'oss' => [
            'driver' => 'oss',
            'access_id' => env('access_id'),
            'access_key' => env('access_key'),
            'bucket' => env('bucket'),
            'endpoint' => 'oss-cn-shenzhen.aliyuncs.com', // OSS 外网节点或自定//'endpoint_internal' => '<internal endpoint [OSS内网节点] 如：oss-cn-shenzhen-internal.aliyuncs.com>', // v2.0.4 新增配置属性，如果为空，则默认使用 endpoint 配置(由于内网上传有点小问题未解决，请大家暂时不要使用内网节点上传，正在与阿里技术沟通中)
